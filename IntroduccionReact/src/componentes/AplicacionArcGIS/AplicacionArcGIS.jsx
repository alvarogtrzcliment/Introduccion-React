...
function AplicacionArcGIS ({ logoLink, logoAlt, nombreApp, descripcionApp, productoLink}){

  let [boton,setBoton] = useState(false)
  
  let ejemplos

  if (nombreApp==='Experience Builder' && boton === true){
    ejemplos = <div className="EjemplosCard">
      <CardEjemplo 
        linkImagen={'https://www.arcgis.com/sharing/rest/content/items/837b6e7124ce42acb15173edf6bc941a/resources/images/widget_21/1662968199811.jpg'}
      ...
      />
      <CardEjemplo
        linkImagen={'https://esridevbeijing.maps.arcgis.com/sharing/rest/content/items/7696613b0bcb4bd7b70f72b33c89c148/data'}
  ...
  if(nombreApp === 'ArcGIS Story Maps'  && boton === true){
    ejemplos = <div className="EjemplosCard">
      <CardEjemplo 
        linkImagen={'https://images.unsplash.com/photo-1615092296061-e2ccfeb2f3d6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
      ...
      />
      <CardEjemplo
        linkImagen={'https://images.unsplash.com/photo-1454789548928-9efd52dc4031?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
        titulo={'T-Minus 6000'}
      ...
      />
      <CardEjemplo
        linkImagen={'https://images.unsplash.com/photo-1524522173746-f628baad3644?q=80&w=2131&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
  ...
  if(nombreApp === 'ArcGIS Dashboards'  && boton === true){
    ejemplos = <div className="EjemplosCard">
      <CardEjemplo
        linkImagen={'https://images.unsplash.com/photo-1584118624012-df056829fbd0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Y292aWR8ZW58MHx8MHx8fDA%3D'}
        titulo={'COVID-19'}
      ...
      />
      <CardEjemplo
        linkImagen={'https://images.unsplash.com/photo-1606050309588-741702cceb9b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZGFtfGVufDB8fDB8fHww'}
      ...
      />
      <CardEjemplo
      linkImagen={'https://images.unsplash.com/photo-1572204097183-e1ab140342ed?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODZ8fGZpcmUlMjBmb3Jlc3R8ZW58MHx8MHx8fDA%3D'}
  ...
  return(
    <>
      <div className="AplicacionArcGIS">
        <img src={logoLink} alt={logoAlt} />
        <div>
          <h3>{nombreApp}</h3>
          <p>{descripcionApp}</p>
          <a href={productoLink}>Página de producto</a>
